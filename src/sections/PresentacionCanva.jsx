...
function PresentacionCanva() {
  return (
    <section id="presentacion-canva" style={{marginBottom: '2rem'}}>
      <h2>Elaboración de mermelada nutracéutica de guayaba</h2>
      <p>
        Puedes ver el paso a paso de la elaboración de la mermelada nutracéutica de guayaba haciendo click en el siguiente enlace:
      </p>
      <a
